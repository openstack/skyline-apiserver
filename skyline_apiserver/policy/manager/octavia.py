...
list_rules = (
    ...
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/loadbalancers")],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="POST", path="/v2.0/lbaas/loadbalancers")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/loadbalancers/{loadbalancer_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="PUT", path="/v2.0/lbaas/loadbalancers/{loadbalancer_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="DELETE", path="/v2.0/lbaas/loadbalancers/{loadbalancer_id}")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/loadbalancers/{loadbalancer_id}/stats")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="GET", path="/v2.0/lbaas/loadbalancers/{loadbalancer_id}/status")],
    ),
    base.APIRule(
        ...
        scope_types=["project"],
        operations=[Operation(method="PUT", path="/v2.0/lbaas/loadbalancers/{loadbalancer_id}/failover")],
    ),
    base.APIRule(
