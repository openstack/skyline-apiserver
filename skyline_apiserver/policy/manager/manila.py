...
list_rules = (
    ...
    base.APIRule(
        ...
        operations=[{"method": "GET", "path": "/os-availability-zone"}, {"method": "GET", "path": "/availability-zone"}],
    ),
    base.APIRule(
        ...
        scope_types=["system"],
        operations=[{"method": "GET", "path": "/scheduler-stats/pools"}, {"method": "GET", "path": "/scheduler-stats/pools?{query}"}],
    ),
    base.APIRule(
        ...
        scope_types=["system"],
        operations=[{"method": "GET", "path": "/scheduler-stats/pools/detail?{query}"}, {"method": "GET", "path": "/scheduler-stats/pools/detail"}],
    ),
    base.APIRule(
        name="share:create",
    ...
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/shares"}, {"method": "GET", "path": "/shares/detail"}],
    ),
    base.APIRule(
        name="share:update",
        check_str=("(rule:system-admin) or (rule:project-member)"),
    ...
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "PUT", "path": "/shares/{share_id}/metadata"}, {"method": "POST", "path": "/shares/{share_id}/metadata/{key}"}, {"method": "POST", "path": "/shares/{share_id}/metadata"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/shares/{share_id}/metadata"}, {"method": "GET", "path": "/shares/{share_id}/metadata/{key}"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system"],
        operations=[{"method": "POST", "path": "/share_instances/{share_instance_id}/export_locations"}],
    ),
    base.APIRule(
        ...
        description="Return data about the requested export location.",
        scope_types=["system"],
        operations=[{"method": "GET", "path": "/share_instances/{share_instance_id}/export_locations/{export_location_id}"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/types"}, {"method": "GET", "path": "/types?is_public=all"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system"],
        operations=[{"method": "GET", "path": "/types/{share_type_id}/extra_specs/{extra_spec_id}"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/snapshots"}, {"method": "GET", "path": "/snapshots/detail"}, {"method": "GET", "path": "/snapshots?{query}"}, {"method": "GET", "path": "/snapshots/detail?{query}"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/snapshots/{snapshot_id}/export-locations/{export_location_id}"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system"],
        operations=[{"method": "GET", "path": "/snapshot-instances"}, {"method": "GET", "path": "/snapshot-instances?{query}"}],
    ),
    base.APIRule(
        ...
        scope_types=["system"],
        operations=[{"method": "GET", "path": "/snapshot-instances/detail"}, {"method": "GET", "path": "/snapshot-instances/detail?{query}"}],
    ),
    base.APIRule(
        ...
        scope_types=["system"],
        operations=[{"method": "POST", "path": "/snapshot-instances/{snapshot_instance_id}/action"}],
    ),
    base.APIRule(
        ...
        scope_types=["system"],
        operations=[{"method": "GET", "path": "/snapshot-instances/{snapshot_instance_id}/export-locations"}],
    ),
    base.APIRule(
        ...
        scope_types=["system"],
        operations=[{"method": "GET", "path": "/snapshot-instances/{snapshot_instance_id}/export-locations/{export_location_id}"}],
    ),
    base.APIRule(
        ...
        scope_types=["system"],
        operations=[{"method": "GET", "path": "/share-servers"}, {"method": "GET", "path": "/share-servers?{query}"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system"],
        operations=[{"method": "GET", "path": "/os-services"}, {"method": "GET", "path": "/os-services?{query}"}, {"method": "GET", "path": "/services"}, {"method": "GET", "path": "/services?{query}"}],
    ),
    base.APIRule(
        name="service:update",
        check_str=("rule:system-admin"),
        ...
        scope_types=["system"],
        operations=[{"method": "PUT", "path": "/os-services/disable"}, {"method": "PUT", "path": "/os-services/enable"}, {"method": "PUT", "path": "/services/disable"}, {"method": "PUT", "path": "/services/enable"}],
    ),
    base.APIRule(
        ...
        scope_types=["system"],
        operations=[{"method": "PUT", "path": "/quota-sets/{tenant_id}"}, {"method": "PUT", "path": "/quota-sets/{tenant_id}?user_id={user_id}"}, {"method": "PUT", "path": "/quota-sets/{tenant_id}?share_type={share_type_id}"}, {"method": "PUT", "path": "/os-quota-sets/{tenant_id}"}, {"method": "PUT", "path": "/os-quota-sets/{tenant_id}?user_id={user_id}"}],
    ),
    base.APIRule(
        name="quota_set:show",
        check_str=("(rule:system-reader) or (rule:project-reader)"),
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/quota-sets/{tenant_id}/defaults"}, {"method": "GET", "path": "/os-quota-sets/{tenant_id}/defaults"}],
    ),
    base.APIRule(
        name="quota_set:delete",
        check_str=("rule:system-admin"),
        description="Delete quota for a tenant/user or tenant/share-type. The quota will revert back to default (Admin only).",
        scope_types=["system"],
        operations=[{"method": "DELETE", "path": "/quota-sets/{tenant_id}"}, {"method": "DELETE", "path": "/quota-sets/{tenant_id}?user_id={user_id}"}, {"method": "DELETE", "path": "/quota-sets/{tenant_id}?share_type={share_type_id}"}, {"method": "DELETE", "path": "/os-quota-sets/{tenant_id}"}, {"method": "DELETE", "path": "/os-quota-sets/{tenant_id}?user_id={user_id}"}],
    ),
    base.APIRule(
        ...
        scope_types=["system"],
        operations=[{"method": "PUT", "path": "/quota-class-sets/{class_name}"}, {"method": "PUT", "path": "/os-quota-class-sets/{class_name}"}],
    ),
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/quota-class-sets/{class_name}"}, {"method": "GET", "path": "/os-quota-class-sets/{class_name}"}],
    ),
    base.APIRule(
        ...
        scope_types=["system"],
        operations=[{"method": "POST", "path": "/share-group-types/{share_group_type_id}/group-specs"}],
    ),
    base.APIRule(
        ...
        scope_types=["system"],
        operations=[{"method": "GET", "path": "/share-group-types/{share_group_type_id}/group-specs"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/share-group-types"}, {"method": "GET", "path": "/share-group-types?is_public=all"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system"],
        operations=[{"method": "POST", "path": "/share-group-types/{share_group_type_id}/action"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/share-group-snapshots/{share_group_snapshot_id}"}],
    ),
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/share-group-snapshots"}, {"method": "GET", "path": "/share-group-snapshots/detail"}, {"method": "GET", "path": "/share-group-snapshots/{query}"}, {"method": "GET", "path": "/share-group-snapshots/detail?{query}"}],
    ),
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "PUT", "path": "/share-group-snapshots/{share_group_snapshot_id}"}],
    ),
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "DELETE", "path": "/share-group-snapshots/{share_group_snapshot_id}"}],
    ),
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "POST", "path": "/share-group-snapshots/{share_group_snapshot_id}/action"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/share-groups"}, {"method": "GET", "path": "/share-groups/detail"}, {"method": "GET", "path": "/share-groups?{query}"}, {"method": "GET", "path": "/share-groups/detail?{query}"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/share-replicas"}, {"method": "GET", "path": "/share-replicas/detail"}, {"method": "GET", "path": "/share-replicas/detail?share_id={share_id}"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/share-replicas/{share_replica_id}/export-locations"}],
    ),
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/share-replicas/{share_replica_id}/export-locations/{export_location_id}"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/share-networks"}, {"method": "GET", "path": "/share-networks?{query}"}],
    ),
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/share-networks/detail?{query}"}, {"method": "GET", "path": "/share-networks/detail"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system"],
        operations=[{"method": "GET", "path": "/share-networks?all_tenants=1"}, {"method": "GET", "path": "/share-networks/detail?all_tenants=1"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "DELETE", "path": "/share-networks/{share_network_id}/subnets/{share_network_subnet_id}"}],
    ),
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/share-networks/{share_network_id}/subnets/{share_network_subnet_id}"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/security-services/detail?{query}"}, {"method": "GET", "path": "/security-services/detail"}],
    ),
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/security-services"}, {"method": "GET", "path": "/security-services?{query}"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system"],
        operations=[{"method": "GET", "path": "/security-services?all_tenants=1"}, {"method": "GET", "path": "/security-services/detail?all_tenants=1"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/shares/{share_id}/export_locations/{export_location_id}"}],
    ),
    base.APIRule(
        ...
        scope_types=["system"],
        operations=[{"method": "GET", "path": "/share_instances"}, {"method": "GET", "path": "/share_instances?{query}"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/messages"}, {"method": "GET", "path": "/messages?{query}"}],
    ),
    base.APIRule(
        name="message:delete",
        check_str=("(rule:system-admin) or (rule:project-member)"),
    ...
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "GET", "path": "/share-access-rules?share_id={share_id}&key1=value1&key2=value2"}],
    ),
    base.APIRule(
    ...
    base.APIRule(
        ...
        scope_types=["system", "project"],
        operations=[{"method": "DELETE", "path": "/share-access-rules/{share_access_id}/metadata/{key}"}],
    ),
)
